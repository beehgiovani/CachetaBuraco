-- Cada mensagem tem uma direcao conhecida. Isso impede um cliente modificado
-- de publicar distribuicao, estado publico, contagem ou resposta do host.
...
begin
    ...
    -- Retry com o mesmo envelope recebe ACK; colisao diferente continua falsa.
    select exists (
        select 1
