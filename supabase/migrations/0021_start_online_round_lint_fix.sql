-- Ajuste cosmetico depois do lint remoto: eu tinha declarado a variavel `i` a
-- toa (o `for i in 1 .. ...` ja declara sozinho), e isso disparava avisos de
-- "shadowed_variables" e "unused variable" no lint. Sem mudanca de comportamento,
-- so removi a declaracao redundante.
