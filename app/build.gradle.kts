...
// keystore.properties fica fora do git (senha em texto puro) -- sem ele,
// build de release simplesmente nao assina (CI/outro dev sem o arquivo
// continua rodando debug/testes normalmente).
